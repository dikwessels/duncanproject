...
<html>
<head>
<title>Inventory Search | As You Like It Silver Shop, New Orleans, Louisiana</title>	
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$.get("/templates/searchResults.html",function(response){
		   template = Handlebars.compile(response);
		   
		   $.get('//www.asyoulikeitsilvershop.com/inventory.json.php',
		  		'pattern=chantilly&brand=gorham&category=f',
		  		function(response){
...
<div class="row desktopOnly">
	...
	<section class="container sixteen colgrid mainContent" role="main">
		...
		<div class="row">
			<div class="sixteen columns" id="searchResults"></div>
		</div>
