...
<tr>
    ...
    echo isSelected($rc, "h") . ">Hollowware</option>
  		<OPTION value=F>";
    echo isSelected($rc, "f") . "Flatware</option>
		<OPTION value=FCS>";
    echo isSelected($rc, "fcs") . "Flatware Complete Sets</option>
		<OPTION value=BS>";
    echo isSelected($rc, "bs") . "Baby Silver</option>
		<OPTION value=CS>";
    echo isSelected($rc, "cs") . "Coin Silver</option>
                <OPTION value=CL>";
    echo isSelected($rc, "cl") . "Collectibles</option>
		<OPTION value=J>";
    echo isSelected($rc, "j") . "Jewelry</option>
...
<!--	
    ...
    echo ">Baby Silver Complete Sets</option>
				<OPTION  value=HCS ";
    if ($row[category] == 'HCS') {
        echo "selected";
    }
    echo ">Holloware Complete Sets</option>		
<OPTION  value=SPCS ";
    if ($row[category] == 'SPCS') {
        echo "selected";
    }
    echo ">Serving Pieces Complete Sets</option> 

-->
		<OPTION value=SP>";
    echo isSelected($rc, "sp") . "Serving Pieces</option>
		<OPTION value=CP>";
    echo isSelected($rc, "cp") . "Cleaning Products</option>
		<OPTION value=STP>";
    echo isSelected($rc, "stp") . "Storage Products</option>
		<OPTION value=XM>";
    echo isSelected($rc, "xm") . "Christmas Ornaments</option>
		</select>
