...
TaxRate               = 0.04;
TaxByRegion           = true;
TaxPrompt             = 'For tax purposes, please select if you are shipping to a Louisiana address before continuing';
TaxablePrompt         = 'Louisiana Shipping Addresses';
...
if ( Language == 'en' || !bLanguageDefined ) {
   ...
   strRButton= "Remove";
   strSUB    = "SUBTOTAL";
   strSHIP   = "SHIPPING AND INSURANCE";
   strTAX    = "TAX";
   strTOT    = "TOTAL";
