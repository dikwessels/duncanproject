<?php
header("Location:http://www.asyoulikeitsilvershop.com/baby-silver/");
exit;
...
$featuredItem=getFeaturedItem($cat);
  ...
  $pageTitle="Baby Silver | As You Like It Silver Shop, New Orleans, Louisiana";
  $pageDescription="Baby Silver, Baby Spoons, Infant Feeding Spoons, Youth Sets";
...
if($gift==1){$category="g";}
  ...
  $sterling=($pattern=="CHRISTOFLE")?"Silverplate ":"";
...
$f.="<div class=\"row\">	
			...
			<div class=\"cell fourColumns topAlign\">
				<a href=\"babysilver.php?cId=$row[id]\" class=\"recentacqs\">
			   ...
			   <div class=\"row\">
			   	...
			   	<div class=\"cell eightColumns\">
			   		<p class=searchrecent>
						<strong>
							<a href=\"babysilver.php?cId=$row[id]\">$row[item]</a>
						</strong>
					</p>
			   	</div>
...
if($imageS2!=''||$imageS3!=''){
	...
	$f.="<div id=\"imageThumbnails\" class=\"row\">
			<div class=\"cell fiveColumns bottomPadFive\">
					<a href=\"javascript:changePicture('$imageS1','$imageB1','$LBcaption')\">
		...
		$f.="<div class=\"cell sixColumns bottomPadFive\">
					<a href=\"javascript:changePicture('$imageS2','$imageB2','$LBcaption2')\">
	...
	if($imageS3){
			$f.="<div class=\"cell fiveColumns bottomPadFive\">
						<a href=\"javascript:changePicture('$imageS3','$imageB3','$LBcaption3')\">
...
$f.="
	...
	if ($row[nextI]!=$row[image1]||$cI) { 
		...
		<div class=\"cell sixteenColumns alignRight\">
			<a href='babysilver.php?cId=$row[id]&cI=$nI'>".(($nI)?"Read More":"Back")."</a>
		</div>	
		</div>"; }
...
<div class=\"row\">
	<div class=\"cell sixteenColumns centered\">
		<b class=recentadesc>&nbsp;&nbsp;<br> 
			<a rel=\"nofollow\" href='$homePage[$cat]?showAll=1' class=recentadesc>View the complete list</A> of As You Like It Silver Shop's featured items in Baby Silver.
	</div>
</div>
";
 }
  ...
  while($row=mysql_fetch_assoc($result)){
    ...
    if($staticFileName!=""){
	    $fileLink=str_replace("/home/asyoulik/public_html","",$staticFileName);
      	...
      	$fileLink="productSearch.php?category=bs&h2=".urlencode($text)."&".$searchText;
    }
