...
//include("/home/asyoulik/public_html/sandbox.emailConfirmation.php");
...
//set this to "" for live function
//$sandbox="sandbox.";
$sandbox="";

if(!$_SESSION['tempCustomerID']){
$values="'','','','','','','','','','".$_SESSION['shippingmethod']."','".$_SESSION['giftwrap']."','".$_SESSION['note']."','".$_SESSION['subtotal']."','','".$_SESSION['shipping']."'";
	
$stmt="INSERT into tblTempInvoiceData(fname,lname,address1,address2,city,state,zip,phone,country,shippingMethod,giftwrap,note,subtotal,tax,shipping) values($values)";
...
//	echo $_SESSION['tempCustomerID']. " has been set";
}
else{
//	echo "Session ID:".$_SESSION['tempCustomerID'];
...
<!-- php code would go here -->
  ...
  <div class="row" id="checkout-forms" style="display:none;">	  
	...
	<span style="display:none" id="form-status"></span>
		...
		<h3 class="inline">Shipping Information 
...
<select validation-rule="required" err-msg="State required." err-msg-target="self" class="validate mini-input" id="state" name="state">
	...
	<span id="state-validate"></span>
		...
		<div class="row" id="use-shipping-checkbox-container">
...
<div class="row giftcard-container no-display" id="pay-with-giftcard">
	<div class="cell sixteenColumns center-align">
		<form action="<? global $sandbox; echo $sandbox;?>order-confirmation.php" method="post">
...
?>
	...
	//var processURL='https://www.asyoulikeitsilvershop.com/process-info.php';
