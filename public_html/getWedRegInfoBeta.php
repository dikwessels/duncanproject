	...
	if($update){
 	...
 	if($success>0){
	  ...
	  showForm($regID,$notice);
	     ...
	     $notice="<!--error-->";//<span id=\"updateStat\" style=\"position:absolute;top:-24px;\" class=\"redtext\">An internal error occurred, please try again.</span>";
	     showForm($regID,$notice);
	 }
  	}
...
<div class='row'>
<div class='cell sixteenColumns'>
	<button id='save-registry' data-regid='$regID'>Save Changes</button>
</div>
</div>
</div>
