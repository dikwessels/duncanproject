<?php
header("Location:http://www.asyoulikeitsilvershop.com/silver-jewelry/");
exit;
...
$featuredItem=getFeaturedItem($cat);
  ...
  $pageTitle="Silver Jewelry | As You Like It Silver Shop, New Orleans, Louisiana";
...
$f.="<div class=\"row\">	
			...
			<div class=\"cell fourColumns topAlign\">
				<a href=\"jewelry.php?cId=$row[id]\" class=\"recentacqs\">
			   ...
			   <div class=\"row\">
			   	...
			   	<div class=\"cell eightColumns\">
			   		<p class=searchrecent>
						<strong>
							<a href=\"jewelry.php?cId=$row[id]\">$row[item]</a>
						</strong>
					</p>
			   	</div>
...
$f.="
	...
	if ($row[nextI]!=$row[image1]||$cI) { 
		...
		<div class=\"cell sixteenColumns alignRight\">
			<a href='jewelry.php?cId=$row[id]&cI=$nI'>".(($nI)?"Read More":"Back")."</a>
		</div>	
		</div>"; }
...
<div class=\"row\">
	<div class=\"cell sixteenColumns centered\">
		<b class=recentadesc>&nbsp;&nbsp;<br> 
			<a rel=\"nofollow\" href='jewelry.php?showAll=1' class=recentadesc>View the complete list</A> of As You Like It Silver Shop's featured items in Jewelry.
	</div>
</div>
";
 }
...
global $staticcats;
  ...
  while($row=mysql_fetch_assoc($result)){
    ...
    if($staticFileName!=""){
	    $fileLink=str_replace("/home/asyoulik/public_html","http://www.asyoulikeitsilvershop.com",$staticFileName);
    }
    else{	
