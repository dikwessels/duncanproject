	...
	<div class="row">
		<div class="three columns">
			<div id="shoppingCartMobile" class="mobileOnly">
				<a href="/shoppingCart.php" title="View Your Shopping Cart">
					<i class="icon-basket"  ></i>
					<span id ="mobileItemCount"style="color:yellow;position:relative;left:-5px;top:-3px;font-family:sans-serif"></span>
				</a>
			</div>
...
<section class="container sixteen colgrid" id="mainContent" role="main">
<? 
...
<ul id="7QipHGnqZ" class="TA_links QmBV1rUI9N">

<li id="fPA5ybWWwjD" class="NVj2OGvDMq">

<a target="_blank" href="http://www.tripadvisor.com/"><img src="https://www.tripadvisor.com/img/cdsi/img2/branding/tripadvisor_sticker_logo_88x55-18961-2.png" alt="TripAdvisor"/></a>
...
<script src="https://www.jscache.com/wejs?wtype=virtualsticker&amp;uniq=805&amp;lang=en_US&amp;locationId=265717&amp;display_version=2"></script>

 
	</span>

	<article id="cleaningProductsNotice" class="row fullWidth desktopOnly">
		<h5 class="eight columns centered">
	...
	<article id="splash" class="row fullWidth desktopOnly">
		<div class="fifteen columns centered">
			<div class="container sixteen colgrid">
				<div class="row">
					<div class="six columns right nopad" >
	...
	<img class="noborder" src="images/entersite_l.jpg" style="width:250px;" alt="Enter As You Like it Silver Shop"></a>
					...
					<div class="five columns left  nopad">
...
<h2 class="brandLink">
	...
	<div id="mobileSearch" class="row fullWidth mobileOnly">
		<div class="sixteen columns">
		<form name="searchFormMobile" class="nopad" action="//www.asyoulikeitsilvershop.com/silver-search.php" method="post">
			<div class="append field">
				<input class="input" id="searchInputMobile" name="terms" placeholder="Search by item name">
	...
	<article class="container sixteen colgrid mobileOnly quickLinks">
	...
	<div class="row">
		<div class="sixteen columns">
			<a href="/silver-cleaning-products.html">
				<h2>Silver Cleaning Products
					<!--<span class="caption">Polish Brushes</span>-->
				</h2>
...
<div class="row">
	...
	<section class="container sixteen colgrid border-top">
		<article class="row">
		<a class="toggle" gumby-trigger="siteDescription"></a>
		<article class="sixteen columns" id="siteDescription">
	
<strong>As You Like it Silver Shop</strong> in New Orleans, Louisiana buys, sells and restores estate sterling silver and silver-plated tableware, flatware, and holloware in active, inactive and obsolete sterling patterns.
...
<div class="container sixteen colgrid desktopOnly border-top" id="categoryLinkContainer">
...
410 North Commerce Street <br>
		...
		<div class="four columns contactInfo">
   ...
   <a class="infoLink" id="privacyPolicy" rel="nofollow" href="privacy.php">Privacy Policy</a>
	...
	<div class="container sixteen colgrid" id="mobileFooter">

	<div class="row fullWidth">
	  <div class="sixteen columns center">
		<a href="tel:+18008282311">Contact Us <i class="icon-phone"></i></a>
	  </div>
  </div>

 <!-- <div class="row">
  	<div class="seven columns push_one">
	  	<a href="contact.php">Store Locations</a>
  	</div>
  	<div class="seven columns push_one"></div>
  </div>
  -->
</div>
...
<script type="text/javascript">
		...
		$(document).ready(
					...
					function(){
						...
						$('.homepageBrandLink').on('mouseover',function(){
