<?php
	...
	include_once("/public_html/categoryArrays.php");
	include_once("/public_html/staticHTMLFunctions.php");
		...
		foreach($localcatArray as $catk=>$catv){
		    ...
		    if($catstaticFileName!=""){
			  ...
			  $catC.="<li class='nodecoration'>
		                 <h3>
		                 	<a href='/$catfileLink' class='footerCategoryLink' title='$text' alt='$text'>$text</a>
		                 </h3>
		              </li>";
		     }
